...
.content {
  @apply pt-5 sm:pt-6 md:pt-7 lg:pt-8;
  @apply flex flex-col items-center;
}

.page-not-found-wrapper h2 {
  @apply pb-2 sm:pb-3 lg:pb-4;
  @apply text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold uppercase;
  @apply font-playfair;
}

.page-not-found-wrapper h4 {
  @apply text-base sm:text-lg lg:text-xl font-medium;
  @apply font-playfair;

  @apply pb-4 sm:pb-8 lg:pb-12;
}
...
.illustration-wrapper {
  @apply w-full sm:w-7/12 md:w-6/12 lg:w-5/12;
}
