<template>
  <div class="container py-16 space-y-16">
    <div class="flex gap-16">
      ...
      <div class="w-7/12">
        <div class="space-y-6">
          <h2 class="text-5xl font-bold text-violet-700">{{ selectedGroup.title }}</h2>
          ...
          <div class="flex gap-4">
            ...
            <div class="flex gap-2 items-center px-3 py-1.5 rounded-md bg-rose-400 text-white">
              ...
              <p><span class="font-bold">{{ selectedGroup.calo }}</span> kcal</p>
            </div>
            ...
            <div class="flex gap-2 items-center px-3 py-1.5 rounded-md bg-violet-500 text-white">
              ...
              <p><span class="font-bold">{{ $filters.toVND(selectedGroup.price) }}</span> </p>
            </div>
          </div>
          ...
          <div class="product-action">
            ...
            <BaseButtonPrimary v-if="enough_quantity" class="!px-8 !py-4" @click="addAllToCart()">
