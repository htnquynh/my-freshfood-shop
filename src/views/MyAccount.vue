        ...
        <router-link to="/account">
          <a :class="{ 'active-link': isCurrentTab('MyAccount') }" class="nav-link">
            <span class="nav-link-content">
              <svg class="nav-link-icon" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24"
            ...
            <svg class="nav-link-arrow" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24"
      ...
      <li>
        <router-link to="/account/my-order">
          <a :class="{ 'active-link': isCurrentTab('MyOrder') }" class="nav-link">
            <span class="nav-link-content">
              <svg class="nav-link-icon" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24"
                height="24px" viewBox="0 0 24 24" width="24px" fill="currentColor">
                <path d="M0,0h24v24H0V0z" fill="none" />
                <g>
                  <path
