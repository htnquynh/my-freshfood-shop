<template>
  <div class="group-item-wrapper">
    <div class="group-item">
      <img class="group-item-image" :src="product.image" alt="image">
      <div class="group-item-spec">
        ...
        <div class="product-action">
          <a v-if="product.status == 'Enable' && product.quantity_remaining > 0" class="btn-add-to-cart"
            @click="addItemToCart()">
          ...
          <p v-if="product.status == 'Disable'"></p>
          <p v-else-if="product.quantity_remaining <= 0">Out of Stock</p>
        </div>
