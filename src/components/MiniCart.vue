    ...
    <div class="cart-panel">
      <div class="cart-header">
        ...
        <router-link to="/shopping-cart">
          <a class="hover:text-gold-500">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd"
                d="M8.5 2.5H15.5C18.8137 2.5 21.5 5.18629 21.5 8.5V15.5C21.5 18.8137 18.8137 21.5 15.5 21.5H8.5C5.18629 21.5 2.5 18.8137 2.5 15.5V8.5C2.5 5.18629 5.18629 2.5 8.5 2.5ZM15.5 20C17.983 19.9945 19.9945 17.983 20 15.5V8.5C19.9945 6.017 17.983 4.0055 15.5 4H8.5C6.017 4.0055 4.0055 6.017 4 8.5V15.5C4.0055 17.983 6.017 19.9945 8.5 20H15.5Z"
                fill="currentColor" />
              <path
                d="M15.1798 7C14.7679 7.00539 14.4352 7.33804 14.4298 7.75C14.4194 8.38126 14.1565 8.98203 13.6998 9.41801C13.2432 9.85398 12.6309 10.0888 11.9998 10.07C10.7 10.1093 9.61331 9.0897 9.56982 7.79C9.56982 7.37579 9.23404 7.04 8.81982 7.04C8.40561 7.04 8.06982 7.37579 8.06982 7.79C8.11358 9.91804 9.8717 11.609 11.9998 11.57C14.128 11.609 15.8861 9.91804 15.9298 7.79C15.9408 7.58425 15.8667 7.38305 15.7248 7.23362C15.583 7.08419 15.3859 6.99971 15.1798 7Z"
                fill="currentColor" />
            </svg>
          </a>
        </router-link>
      ...
      <div v-show="noItems != 0" class="cart-main">
        <div class="cart-list-items">
          <MiniCartItem v-for="item in cart.cartItems" :key="item.id" :item="item" />
        </div>
      </div>
      ...
      <div class="cart-footer">
        <div class="mini-cart-action">
          ...
          <button :disabled="hasUnavailableProduct" class="btn-checkout" @click="goCheckout()">
